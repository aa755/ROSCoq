...
bindInstanceNodeHaskell :: (a1 -> Node a2) -> (Node a1) -> Node a2
bindInstanceNodeHaskell f x =
  nbind x f

type TopicName = Prelude.String
...
__data :: Ros.Std_msgs.String.String -> Prelude.String
__data = Ros.Std_msgs.String.__data
...
procStr :: Prelude.String -> Prelude.String
procStr s =
  append ((:)
    ((\b0 b1 b2 b3 b4 b5 b6 b7 -> Data.Char.chr (
      (if b0 then Data.Bits.shiftL 1 0 else 0) Prelude.+
    ...
    Prelude.False Prelude.True Prelude.False) ((:)
    ((\b0 b1 b2 b3 b4 b5 b6 b7 -> Data.Char.chr (
      (if b0 then Data.Bits.shiftL 1 0 else 0) Prelude.+
      (if b1 then Data.Bits.shiftL 1 1 else 0) Prelude.+
      (if b2 then Data.Bits.shiftL 1 2 else 0) Prelude.+
      ...
      (if b6 then Data.Bits.shiftL 1 6 else 0) Prelude.+
      (if b7 then Data.Bits.shiftL 1 7 else 0)))
    Prelude.False Prelude.False Prelude.False Prelude.False Prelude.False
    Prelude.True Prelude.False Prelude.False) ((:)
    ((\b0 b1 b2 b3 b4 b5 b6 b7 -> Data.Char.chr (
      (if b0 then Data.Bits.shiftL 1 0 else 0) Prelude.+
      (if b1 then Data.Bits.shiftL 1 1 else 0) Prelude.+
    ...
    ((\b0 b1 b2 b3 b4 b5 b6 b7 -> Data.Char.chr (
      ...
      (if b7 then Data.Bits.shiftL 1 7 else 0)))
    Prelude.False Prelude.False Prelude.False Prelude.False Prelude.False
    Prelude.True Prelude.False Prelude.False) ([]))))))))) s

procStrMsg :: Ros.Std_msgs.String.String -> Ros.Std_msgs.String.String
procStrMsg s =
  Ros.Std_msgs.String.String (procStr (__data s))

echoNode :: Node ()
echoNode =
  bind (unsafeCoerce (\_ _ -> bindInstanceNodeHaskell)) (\strmIn ->
    publish rOSMsgInstance_ROS_StdMsg_String chatterecho
      (coMap procStrMsg strmIn))
