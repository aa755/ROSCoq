...
Let ta := (@targetAngle ('Mazda3Sedan2014sGT) rp eps 20 (csrigid2D initSt)).
Let tarl := (@revTargetAngleL ('Mazda3Sedan2014sGT) rp  eps 20 (csrigid2D initSt)).
Let tarb := (@revTargetAngleB ('Mazda3Sedan2014sGT) rp  eps 20 (csrigid2D initSt)).
...
*)
Definition toPrint : string := animateSpaceReqOpt acceptableGeometryMazda extra (2)%positive.
